...
namespace Bay {
    ...
    public partial class DataSet6 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row AddDataTable1Row(int id_detales, string item_name, string price, string qualty, string total, string username, System.DateTime date) {
...
namespace Bay.DataSet6TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        detales_pur.id_detales, Items.item_name, detales_pur.price, detales_pur.qualty, detales_pur.total, detales_pur.username, detales_pur.date
FROM            detales_pur INNER JOIN
                         Items ON detales_pur.id = Items.id
WHERE        (detales_pur.date BETWEEN @start AND @end)";
        ...
        public virtual int Fill(DataSet6.DataTable1DataTable dataTable, string start, string end) {
        ...
        public virtual DataSet6.DataTable1DataTable GetData(string start, string end) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((start == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
